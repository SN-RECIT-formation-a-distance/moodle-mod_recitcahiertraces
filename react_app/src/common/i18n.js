...
i18n.setLang("fr");
i18n.addTag("appName", "RÉCIT Cahier de traces", "RÉCIT Cahier de traces");
i18n.addTag("search", "Search", "Rechercher");
i18n.addTag("previousStudent", "Previous Student", "Élève précédent");
i18n.addTag("nextStudent", "Next Student", "Élève suivant");
