 ...
 */
if (!class_exists('RecitMySQLConn')) {
    class RecitMySQLConn
    {
        ...
        protected function convertMySQLToPHPDataTypes($type, $value){
            ...
            case 246:
                ...
                case 7:
                case 10:
                    $result = ($value == null ? null : new DateTime($value, new DateTimeZone($this->timezone)));
                    break;
                case 12:
                    $result = ($value == null ? null : DateTime::createFromFormat('Y-m-d H:i:s', $value, new DateTimeZone($this->timezone)));
                    break;
                default:
                    $result = $value;
                    break;
